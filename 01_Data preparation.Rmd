...
# plus time it took them to fill out he survey
#############################
...
youth2010$gaming <- NA
youth2010$socialmedia <- NA
youth2010$streaming <- NA

youth2015$gaming <- NA
youth2015$socialmedia <- NA
youth2015$streaming <- NA

youth2010$duration_seconds <- NA
youth2015$duration_seconds <- NA
...
vars <- c("id", "year", "wph", "schooltype", "gender", "age", "mig_lang", "migback",
          ...
          "gaming", "socialmedia", "streaming", "duration_seconds")
