...
youth2010$german_at_home[youth2010$migback == "none"|youth2010$migback == "father"|youth2010$migback == "mother"] <- 1 # at most one parent with migback
...
youth2023$german_at_home <- NA
youth2023$german_at_home[youth2023$migback == "none"|youth2023$migback == "mother"|youth2023$migback == "father"] <- 1
...
```{r school_id}
#########################
# OPEN ISSUES HERE -- the school information for 2015 doesnt seem to work out
# individual schools have multiple types of schulart
#########################
...
##########################
table(youth2015$school_id, youth2015$schulart)
...
youth2010[, imp_names] <- 6 - youth2010[, imp_2010] 
youth2015[, imp_names] <- 6 - youth2015[, imp_2015] 
youth2023[, imp_names] <- 6 - youth2023[, imp_2023] 


# Check recoding
prop.table(table(youth2010[,imp_2010[10]]))
prop.table(table(youth2010$imp_kids))

prop.table(table(youth2015[,imp_2015[10]]))
prop.table(table(youth2015$imp_kids))

prop.table(table(youth2023[,imp_2023[10]]))
prop.table(table(youth2023$imp_kids))
...
# Problem items
#############################
# These have some major issues for comparability across years
