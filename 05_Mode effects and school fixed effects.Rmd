...
# Is response mode correlated with gender?
prop.table(table(combined_2023$gender, combined_2023$source), margin = 1)
chisq.test(table(combined_2023$gender, combined_2023$source))
