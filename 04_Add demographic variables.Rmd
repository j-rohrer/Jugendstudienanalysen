...
```{r final}
library(splines2)
explanandum_demo_final <- lm(satis ~ as.factor(year)*gender*bs(age, df = 3)*as.factor(schooltype)*as.factor(mig_lang),
                             data = combined)
...
# Look at comparisons for 2010 demographics
...
# Calculate widening of the gender gap
widening_per_year <- avg_comparisons(explanandum_age_spline, variables = "gender", by = c("age", "year"), newdata = all2010,
