...
### Some additional information on the match between target population and our sample

As stated in the manuscript, the City of Leipzig aimed to sample in accordance with the actual distribution of students across the school types and grade levels included.
The following plots illustrate the joint distribution of those two variables in the target population of interest (students in Leipzig, attending grade levels 7 to 12 in general secondary and grammar schools) vs. in our sample.

![2010 distribution](Plots/distribution_2010.png){width=50%}
![2015 distribution](Plots/distribution_2015.png){width=50%}

![2023 distribution](Plots/distribution_2023.png){width=50%}
